...
class TestMetadataService:
    ...
    def test_get_movie_data_with_year_in_title(self):
        ...
        with patch(
            "src.services.metadata.requests.get", return_value=mock_response
        ) as mock_get:
    ...
    def test_get_movie_data_timeout(self):
        ...
        with patch(
            "src.services.metadata.requests.get",
    ...
    def test_get_movie_data_empty_title(self):
        ...
        mock_response_data = {"Response": "False", "Error": "Incorrect IMDb ID."}
