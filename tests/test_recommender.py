...
class TestMovieRecommender:
    ...
    def test_generate_recommendations_dataframe_structure(self, mock_movie_dict, mock_unique_genres, 
        ...
        recommender.scaler_user, recommender.scaler_item, recommender.scaler_target = mock_scalers
        ...
        if not result.empty:
            ...
            assert 3 in recommended_movie_ids or 4 in recommended_movie_ids or 5 in recommended_movie_ids
    
    def test_generate_recommendations_sorted_by_rating(self, mock_movie_dict, mock_unique_genres,
                                                       mock_item_vecs, mock_scalers, mock_model):
    ...
    def test_generate_recommendations_movie_not_in_dict(self, mock_movie_dict, mock_unique_genres,
                                                        mock_item_vecs, mock_scalers, mock_model):
    ...
    def test_is_ready_true(self, mock_movie_dict, mock_unique_genres, mock_item_vecs, mock_scalers, mock_model):
